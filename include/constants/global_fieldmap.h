...
#define PLAYER_STATE_USE_HM         4
#define PLAYER_STATE_WATERING       5
#define PLAYER_STATE_POKEATHLON     6
#define PLAYER_STATE_FISHING        7
#define PLAYER_STATE_POKETCH        8
...
#define PLAYER_TRANSITION_LADDER         1 << 9
#define PLAYER_TRANSITION_ROCKET         1 << 10
#define PLAYER_TRANSITION_ROCKET_HEAL    1 << 11
#define PLAYER_TRANSITION_POKEATHLON     1 << 12
#define PLAYER_TRANSITION_APRICORN_SHAKE 1 << 13
#define PLAYER_TRANSITION_ROCKET_SAVING  1 << 14
